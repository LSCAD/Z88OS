...
***********************************************************************/ 
/***********************************************************************
* mc388n: zweidimensional: Typ 7/8 --> Typ 7/8
* Diese Routine ist fast voellig identisch zur MC888. Der einzige
* Unterschied: Hier: nfg= 2*nkp, bei MC888: nfg= 3*nkp. Muss aber
