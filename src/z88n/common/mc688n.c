...
***********************************************************************/ 
/***********************************************************************
* mc688n: dreidimensional: Typ 21 --> Typ 21
* 21.7.2011 Rieg
***********************************************************************/
...
extern FR_INT4 j21sta[];
extern FR_INT4 i21sta[];
extern FR_INT4 k21sta[];
...
*---------------------------------------------------------------------*/
  if(iss == 1)
    ...
    ioffss[iss]= ioffss[iss-1] + 
                 (jel[iss-1]*2+1)*(iel[iss-1]*2+1)*(kel[iss-1]+1);
...
for(iss = 1;iss <= ness;iss++)
 ...
 PD5B PD5B PD5B PD5B PD5B PD5 "\n",
        koilo[ 1],koilo[ 2],koilo[ 3],koilo[ 4],koilo[ 5],
        koilo[ 6],koilo[ 7],koilo[ 8],koilo[ 9],koilo[10],
        koilo[11],koilo[12],koilo[13],koilo[14],koilo[15],koilo[16]);
        }
      }
    }
  }
