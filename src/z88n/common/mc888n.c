...
***********************************************************************/ 
/***********************************************************************
* mc888n: zweidimensional: Typ 20 --> Typ 20
* Diese Routine ist fast voellig identisch zur MC388. Der einzige
* Unterschied: Hier: nfg= 3*nkp, bei MC388: nfg= 2*nkp. Muss aber
* sein, weil hier die Information ipflag fehlt.
* 21.7.2011 Rieg
***********************************************************************/
...
*---------------------------------------------------------------------*/
    for(j = 1;j <= jmax;j++)                          /* 680 */
      {
      jgerad= j+1 -((j+1)/2)*2;
      for(i = 1;i <= imax;i++)                        /* 670 */
        {
        icount++;
        igerad= i+1 -((i+1)/2)*2;
...
*.....................................................................*/ 
            ...
            if(jndex > 0 && jndex < iss)              /* if */
              ...
              for(index = min;index <= max;index++)   /* 650 */  
                {
                xmax= x[index] + epsx;
                xmin= x[index] - epsx;
                ymax= y[index] + epsy;
